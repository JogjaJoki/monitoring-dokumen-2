...
<head>
    ...
    <title>{{ 'Aplikasi Monitoring Dokumen' }}</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                <span class="brand-text font-weight-light">Monitoring Dokumen</span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-header">MASTER DATA</li>
                            ...
                            @endif
                            <li class="nav-item">
                                <a href="{{ route('admin.document.search') }}"
                                    class="nav-link">
                                    <i class="nav-icon fas fa-database"></i>
                                    <p>
                                        Lihat Dokumen
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.document.report') }}"
                                    class="nav-link">
